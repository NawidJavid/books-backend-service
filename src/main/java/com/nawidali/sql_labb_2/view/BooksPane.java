...
public class BooksPane extends VBox {
    ...
    private void initMenus(Controller controller) {
        ...
        fileMenu.getItems().addAll(exitItem, connectItem, disconnectItem, loginItem);
        ...
        // File menu actions
        exitItem.setOnAction(event -> controller.onExitSelected());
        connectItem.setOnAction(event -> controller.onConnectSelected());
        disconnectItem.setOnAction(event -> controller.onDisconnectSelected());
        loginItem.setOnAction(event -> controller.onLoginSelected());
        ...
        removeItem.setOnAction(event -> controller.onRemoveBookSelected());
        updateItem.setOnAction(event -> controller.onBookActionsSelected());
    }
